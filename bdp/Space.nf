...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Space))==(?);
  Inherited_List_Constants(Machine(Space))==(?);
  List_Constants(Machine(Space))==(?)
END
&
THEORY ListSetsX IS
...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(Space))==(btrue)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(Space)) == (? | ? | ? | ? | ? | ? | ? | ? | Space);
  List_Of_HiddenCst_Ids(Machine(Space)) == (? | ?);
  List_Of_VisibleCst_Ids(Machine(Space)) == (?);
